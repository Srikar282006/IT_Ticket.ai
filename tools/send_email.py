...
SMTP_PORT=587
SENDER_EMAIL="srikarmach@gmail.com"
SENDER_PASSWORD="jjxq dyks ezgl ialw"
...
"""
    success=send_email(to_email="srikarmach@gmail.com",subject=subject,body=body)
    return {"content":"Email sent to IT support." if success else "Failed to send email"}
